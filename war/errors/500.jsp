...
<%= ErrorMessage.getErrorHTML("<h2>Error 500: Big Time Error</h2><br />" +
		"We recommend you go <a href=\"/\">home</a>. This is definitely is our fault, please, " + 
		"<a href=\"/bugs.jsp\">report it.</a>") %>
